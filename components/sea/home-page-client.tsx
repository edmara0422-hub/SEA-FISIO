        ...
        <div className="w-full max-w-xl text-center">
          <div className="relative mx-auto aspect-square w-full max-w-[320px] overflow-hidden rounded-full border border-white/20 bg-black/35 shadow-2xl sm:max-w-[380px]">
            {sceneReady ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.16),transparent_62%)]">
                <div className="h-24 w-24 rounded-full border border-white/20 bg-white/8 shadow-[0_0_80px_rgba(255,255,255,0.18)]" />
              </div>
            )}
        ...
        <div className="absolute inset-0">
          {heroReady ? (
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.14),transparent_54%)]">
              <div className="absolute left-1/2 top-1/2 h-52 w-52 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/12 bg-white/6 shadow-[0_0_120px_rgba(255,255,255,0.16)]" />
            </div>
          )}
        </div>
