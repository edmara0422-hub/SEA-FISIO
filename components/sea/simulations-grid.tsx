...
export function SimulationsMarquee() {
  ...
  return (
    <div className="relative overflow-hidden" style={{ height: 'clamp(210px, 38vw, 290px)' }}>
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12" style={{ background: 'linear-gradient(to right, #010101, transparent)' }} />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12" style={{ background: 'linear-gradient(to left, #010101, transparent)' }} />
